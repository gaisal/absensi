...
<body class="bg-gradient-primary">
 ...
 <!-- Nav Item - DATA SISWA Collapse Menu -->
 <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ManageUsers.php">Tambah Data Siswa</a>
                        <a class="collapse-item" href="data_siswa.php">Data Siswa</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Tabel Absensi Siswa:</h6>
                        <a class="collapse-item" href="data_absensi.php">Data Absensi</a>
                    </div>
                </div>
            </li>
